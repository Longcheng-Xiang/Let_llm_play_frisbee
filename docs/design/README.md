...
5. [Game rules and configuration](game_rules_and_config.md) lists the current field, roster, stall, throw score, disc speed, and default settings.
6. [Cost and model setup](cost_and_models.md) explains API cost, tested model settings, and stop behavior.
7. [Changing models](model_switching.md) explains what to edit when using another provider or model.
